#ifndef ARIA_COMMON_MACROS_H_
#define ARIA_COMMON_MACROS_H_
...
#define ARIA_POINTER_TYPEDEFS(TypeName)                   \
...
#define ARIA_DELETE_COPY_CONSTRUCTORS(TypeName) \
  TypeName(const TypeName&) = delete;           \
  void operator=(const TypeName&) = delete

namespace aria {}

#endif  // ARIA_COMMON_MACROS_H_
